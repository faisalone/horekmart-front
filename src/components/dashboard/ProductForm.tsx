...
export default function ProductForm({ product, onSubmit, onCancel, isLoading, mode }: ProductFormProps) {
	...
	// Fetch categories, vendors, and site settings for dropdowns and watermark
	...
	// Extract logo_watermark from site settings
	const logoWatermark = useMemo(() => {
		if (!siteSettings) return null;
		const allSettings = Object.values(siteSettings).flat();
		const logoSetting = allSettings.find(setting => setting.key === 'logo_watermark');
	...
	return (
		<div className="max-w-7xl mx-auto">
			...
			<div className="px-6 pb-6">
				<form id="product-form" onSubmit={handleSubmit} className="xl:grid xl:grid-cols-3 xl:gap-6 space-y-6 xl:space-y-0 mt-6">
							...
							<CardContent className="space-y-4">
								<div>
									...
									<Input
										...
										className={`bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-blue-500 ${errors.name ? 'border-red-500 focus:border-red-500' : ''
											}`}
									/>
							...
							{/* Product Images */}
								...
								<CardContent>
									<ImageUpload
										...
										onWatermarkChange={setEnableWatermark}
					...
					<div className="xl:col-span-1">
						<div className="space-y-6 xl:sticky xl:top-[120px] xl:z-10">
							<div className="space-y-6 xl:max-h-[calc(100vh-160px)] xl:overflow-y-auto xl:pr-2 xl:pb-1 xl:-mr-2 scrollbar-none dark:scrollbar-none !scrollbar-none dark:!scrollbar-none">
								...
								<CardContent className="space-y-4">
									...
									<div>
										...
										<Input
											...
											placeholder="0.00"
											className={`bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-blue-500 ${errors.price ? 'border-red-500 focus:border-red-500' : ''
												}`}
										/>
									...
									<div>
										...
										<Input
											...
											placeholder="0.00"
											className={`bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-blue-500 ${errors.sale_price ? 'border-red-500 focus:border-red-500' : ''
												}`}
										/>
									...
									<div>
										...
										<Input
											...
											placeholder="0"
											className={`bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:border-blue-500 ${errors.stock_quantity ? 'border-red-500 focus:border-red-500' : ''
												}`}
										/>

...
function LoginPageContent() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      // Use server's recommended auth method (don't override with client preference)
      const serverAuthMethod = result.auth_method as 'password' | 'otp'

      // Save for the verify page - use server's preference
      setSessionItem(AUTH_SESSION_KEYS.INITIAL_AUTH_METHOD, serverAuthMethod)
      if (result.expires_at) {
        setSessionItem(AUTH_SESSION_KEYS.OTP_EXPIRES_AT, result.expires_at)
      }
      if (result.auth_methods) {
        setAuthMethods(result.auth_methods)
      }
          ...
          <div className="p-8 flex flex-col justify-center space-y-3">
            <div className="text-left">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                Sign in to your Horekmart Dashboard to manage your business operations efficiently.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-6 flex-1 flex flex-col justify-center">
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-400 leading-relaxed">
                  Enter your email address or phone number to continue. We&apos;ll help you sign in securely.
                </p>
              </div>
            </div>
          </div>

        ...
        <section id="flash-deals" className="theme-gradient-primary text-white py-16 relative overflow-hidden scroll-mt-32">
          ...
          <div className="max-w-7xl mx-auto px-4 relative">
            ...
            <div className="text-center mt-12">
              <Link href="/products?type=deals" className="inline-flex items-center text-white hover:text-white/80 text-lg font-semibold bg-white/10 hover:bg-white/20 px-8 py-4 rounded-full transition-all hover:scale-105 border-2 border-white/30">
      ...
      <AnimatedElement animation="slideLeft" delay={500}>
        <section className="py-16 bg-theme-subtle-primary">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center mt-8">
              <Link href="/products?type=newest-desc" className="inline-flex items-center text-theme-secondary hover:text-theme-secondary-dark text-lg font-semibold bg-theme-secondary/10 hover:bg-theme-secondary/20 px-6 py-3 rounded-full transition-all hover:scale-105">
